...
PROMPT = ('These four images are chronological frames from one assembly action. '
...
def main():
    ...
    try:
        ...
        processor=AutoProcessor.from_pretrained(cfg['model'],revision=cfg['model_revision'],min_pixels=64*32*32,max_pixels=324*32*32)
        ...
        model=get_peft_model(model,LoraConfig(r=32,lora_alpha=64,lora_dropout=0.05,bias='none',task_type='CAUSAL_LM',target_modules=targets))
